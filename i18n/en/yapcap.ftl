...
accounts-empty-description = Add an account to get started.
provider-enable = Enable { $provider }
codex-accounts-title = Codex Accounts
import-from-opencode = Import from OpenCode
opencode-importing = Importing credentials from OpenCode...
minimax-api-key-imported-from-opencode = API key imported from OpenCode. Edit to change or clear.
opencode-go-api-key-placeholder = API Key
opencode-go-api-key-imported-from-opencode = API key imported from OpenCode. Edit to change or clear.
opencode-go-login-editing = Enter your OpenCode Go API key.
opencode-go-login-failed = Failed to save OpenCode Go account.
...
kimi-login-editing = Enter your Kimi API key
kimi-login-failed = Kimi login failed
kimi-api-key-placeholder = API Key
kimi-api-key-imported-from-opencode = Pre-filled from your OpenCode auth file
...
refresh-section-title = Refresh interval (minutes)
refresh-interval-label = Auto refresh interval
refresh-interval-tooltip = Refresh usage data at the selected interval.
refresh-interval-1-tooltip = Refresh usage data every minute.
refresh-interval-5-tooltip = Refresh usage data every 5 minutes.
refresh-interval-15-tooltip = Refresh usage data every 15 minutes.
refresh-interval-30-tooltip = Refresh usage data every 30 minutes.
...
panel-icon-logo-and-bars-tooltip = Show the provider logo and usage bars in the panel.
panel-icon-bars-only-tooltip = Show only usage bars in the panel.
panel-icon-logo-and-percent-tooltip = Show the provider logo and first usage percentage in the panel.
...
reset-time-relative-tooltip = Show how long remains until the usage window resets.
reset-time-absolute-tooltip = Show when the usage window resets.
usage-amount-section-title = Usage amount
usage-amount-used = Used
usage-amount-left = Left
usage-amount-used-tooltip = Show how much usage has been used.
usage-amount-left-tooltip = Show how much usage remains.
...
provider-detected-cta = { $provider } was detected on this machine, but no account has been added yet.
...
usage-label = Usage
status-label = Status
account-pager-previous = Previous account
account-pager-next = Next account
account-pager-fallback = Account { $n }
account-pager-position = { $current } of { $total }
