...
cursor-account-reauth-badge = Inactive
cursor-account-reauth-needed = This account is inactive
...
cursor-accounts-reauth-summary = One or more Cursor accounts are inactive.
...
badge-cursor-inactive = Inactive
badge-cursor-inactive-tooltip = Log into this account in Cursor and rescan to resume updates
